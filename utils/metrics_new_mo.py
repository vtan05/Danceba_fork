...
def calc_and_save_feats_gt(root):
    ...
    for npz in os.listdir(root):
        ...
        if os.path.isdir(os.path.join(root, npz)):
            continue
        joint3d = process_gtmotion(os.path.join(root, npz))
...
def process_gtmotion(motion_path):
    import numpy as np
    import torch
...
if __name__ == '__main__':
    ...
    gt_root = '/host_data/van/Danceba/motorica/smpl'
    pred_root = '/host_data/van/Danceba/motorica/cc_motion_gpt/eval/pkl/ep000300'
